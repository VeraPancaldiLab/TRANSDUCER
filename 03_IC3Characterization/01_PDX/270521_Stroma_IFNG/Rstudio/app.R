...
setwd("/home/jacobo/Documents/03_Sauyeun_paper/01_PDX/270521_Stroma_IFNG/Rstudio/")
...
plotit=function(df,type){
  ...
  if(type=="ica"){
    ...
    g=ggplot(df,aes(x=tot,y=polysome,col=residuals,label=CITID))+stat_smooth(method="lm",col="black",fill="#d8d8d8")+scale_color_gradient2(midpoint=0, low="blue3", mid="#f4f4f4",high="red3")+theme_light()+geom_point(size=5,col="black")+geom_point(size=4)
  }
  g
}
