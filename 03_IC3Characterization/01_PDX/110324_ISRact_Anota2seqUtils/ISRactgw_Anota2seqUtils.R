...
TEs_5perc_up_enrich_PA@result %>%  
  plot_bar_enrich(0.05,"Reactome Upregulated in ISRact (extreme gene weights)")

TEs_5perc_down_enrich_PA@result %>%  
  plot_bar_enrich(0.05,"Reactome Downregulated in ISRact (extreme gene weights)")
...
TEs_5perc_up_enrich_GO@result %>%  
  plot_bar_enrich(0.05,paste0("GO-", ont," Upregulated in ISRact (extreme gene weights)"))

TEs_5perc_down_enrich_GO@result %>%  
  plot_bar_enrich(0.05, paste0("GO-", ont," Downregulated in ISRact (extreme gene weights)"))
