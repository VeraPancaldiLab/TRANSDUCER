...
```{r}
FeaturePlot(seurat_object, reduction = "umap", features = AUC_names)
FeaturePlot(seurat_object, reduction = "umap", features = c("Moffitt_basal", "Moffitt_classical", "Bailey_squamous", "Bailey_progenitor","Collison_QM", "Collison_classical", "MALIGNANT CELLS" )) 
```
