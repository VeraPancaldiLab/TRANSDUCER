...
#bbduk.sh in=${fastq1} in2=${fastq2} out=${OUTDIR}/${name}kf${fwd_id} out2=${OUTDIR}/${name}kf${rev_id} ref=adapters,artifacts,phix k=31 hdist=1 stats=${OUTDIR}/${name}kf_stats.txt
